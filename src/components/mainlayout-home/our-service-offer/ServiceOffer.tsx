...
const ServiceOfferPage = () => {
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      <h2 className="text-3xl font-bold text-center mb-8 text-gray-800 font-montserrat">
        What We Offer
      </h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {/* Fast Delivery Offer */}
        <div className="flex flex-col items-center text-center bg-white shadow-lg rounded-lg p-6 border-2 border-gray-200 hover:border-gray-400 transition-all duration-300">
          <Image
